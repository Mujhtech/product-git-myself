...
let defaultState = { byId: {}, allIds: [{id: 1, name: "Facebook", countComments: 1, countUpvotes: 1, currentUserUpvoted: 1, tagline: "hello"}, {id:2, name: "Twitter", countComments: 1, countUpvotes: 1, currentUserUpvoted: 1, tagline: "hello"}] };
